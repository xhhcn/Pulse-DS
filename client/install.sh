...
# Usage: curl -sSL https://raw.githubusercontent.com/xhhcn/Pulse-DS/main/client/install.sh | sudo bash -s -- --id YOUR_ID --server http://YOUR_SERVER:8080
#
...
show_help() {
    ...
    echo "  --port PORT          Pull-mode listener port (optional, default: 0 = disabled)"
    ...
    echo ""
    echo "Or using curl:"
    echo "  curl -sSL https://raw.githubusercontent.com/xhhcn/Pulse-DS/main/client/install.sh | sudo bash -s -- --id my-server-1 --server http://monitor.example.com:8080 --secret my-secret"
}
