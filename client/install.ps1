...
.EXAMPLE
    ...
    irm https://raw.githubusercontent.com/xhhcn/Pulse-DS/main/client/install.ps1 | iex
#>
...
# 0 = no HTTP listener (push mode only, nothing exposed); set ClientPort to enable pull mode.
$script:ClientPort = if ($env:ClientPort) { $env:ClientPort } else { "0" }
